module OAuth2::Provider::Models
  autoload :ActiveRecord, 'oauth2/provider/models/orm/active_record'
  autoload :Mongoid, 'oauth2/provider/models/orm/mongoid'
  autoload :DataMapper, 'oauth2/provider/models/orm/datamapper'
